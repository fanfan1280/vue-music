  ...
  <div class="player" v-show="playlist.length > 0">
    ...
    >
      ...
      >
        ...
        <scroll class="middle-r" :data="currentLyric.lines" ref="lyricList">
    ...
    <audio :src="currentSong.url" ref="audio" @play="ready" @timeupdate="updateTime" @ended="end"></audio>
  </div>
</template>
